  ...
  return (
    <div>
      ...
      <form action="" onSubmit={handleSubmit} className="flex flex-col gap-2">
        ...
        {publicId && <button onClick={removeImage} className="rounded-md py-2 px-4 font-bold w-fit bg-red-600 text-white">remove image</button>}
        <select
          onChange={(e) => setSelectedCategory(e.target.value)}
          name=""
          id=""
          className="p-3 rounded-md appearance-none border"
        >
